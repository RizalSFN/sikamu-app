        ...
        <div
            ...
            <div class="block mx-auto py-auto px-5 py-5">
                <a href="{{ route('profil') }}"
                    ...
                    <div>
                        <svg class="h-24 group-hover:bg-black p-3 mx-auto" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 448 512">
                            <path fill="#ffffff"
                ...
                <a href="{{ route('bantuan') }}"
                    class="block w-8/12 mx-auto rounded-md text-1xl py-5 px-5 mt-5 bg-gradient-to-r  from-cyan-950 to-cyan-700 text-cyan-100 hover:text-cyan-400 transition transform duration-300 ease-in-out">
                    <div>
                        <svg class="h-24 p-3 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                            <path fill="#ffffff"
