...
<div class="relative overflow-hidden bg-cover  text-center bg-center bg-fixed h-screen"
  ...
  <div class="pt-24 md:pt-8">
      ...
      <table class="mt-6 text-left mx-auto mb-8 ">
        <tr>
          <td>
            Nama
          </td>
      ...
      <button class="rounded-md py-5 px-5 mt-5 bg-gradient-to-r  from-cyan-950 to-cyan-700 text-cyan-100 hover:text-cyan-400">LOGOUT!</button>
    </div>
</div>
